...
public class Main {
    ...
    /*
     * Teniendo en cuenta que lo primordial es la eficiencia, y la complejidad, GPT
     * me recomendó usar una cola de prioridad y buckets, que es lo que finalmente
     * implementé. La idea es tener 5 listas enlazadas (una por cada nivel de
     * triage), y cada lista mantiene el orden FIFO de llegada. Para atender, se
